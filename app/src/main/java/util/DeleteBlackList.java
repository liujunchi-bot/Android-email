...
public class DeleteBlackList {
    public static String deleteBlackList(MyBlackList myBlackList){
...
//            System.out.println("param2:"+ URLDecoder.decode(param,"UTF-8"));
        ...
        String urlPath = "http://49.234.72.60:8080/wemail_master_war_exploded/AndroidDelBlacklistServlet" ;        //服务器
