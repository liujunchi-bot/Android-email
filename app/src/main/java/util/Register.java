...
public class Register {
    ...
    public static String register(User user){
        ...
        String jsonStringFromAndroid = JSON.toJSONString(user);
        //String jsonStringFromAndroid;
        String param = null;
        try {
//            System.out.println("jsonStringFromAndroid:"+jsonStringFromAndroid);
            //jsonStringFromAndroid = "{\"nickname\":\""+user.getNickname()+"\",\"account\":\""+user.getAccount()+"\",\"password\":\""+user.getPassword()+"\",\"pop3State\":0,\"role\":0,\"smtpstate\":0,\"usedsize\":0}";
...
//            System.out.println("param2:"+ URLDecoder.decode(param,"UTF-8"));
        ...
        String urlPath = "http://49.234.72.60:8080/wemail_master_war_exploded/AndroidRegisterServlet" ;        //服务器
