...
public class SendMail2 {
    public static String sendMail2(Mail mail){
        //HttpURLConnection connection = null;
        //InputStream in = null;
        StringBuffer sb = new StringBuffer();
        String jsonStringFromAndroid = JSON.toJSONString(mail);
        String param = null;
        try {
...
//            System.out.println("param2:"+ URLDecoder.decode(param,"UTF-8"));
        ...
        String urlPath = "http://49.234.72.60:8080/wemail_master_war_exploded/AndroidSendInnerMailServlet" ;        //服务器
